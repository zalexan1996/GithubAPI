...
#>
Function List-CommitsOnAPullRequest
{
    [CmdletBinding()]
    Param(
    ...
    {
        $FinalURL = "https://api.github.com/repos/$owner/$repo/pulls/$pull_number/commits?$($QueryStrings -join '&')"
    }
    else
    {
        $FinalURL = "https://api.github.com/repos/$owner/$repo/pulls/$pull_number/commits"
    }
