...
#>
Function Create-ReactionForAnIssueComment
{
    [CmdletBinding()]
    Param(
    ...
    {
        $FinalURL = "https://api.github.com/repos/$owner/$repo/issues/comments/$comment_id/reactions?$($QueryStrings -join '&')"
    }
    else
    {
        $FinalURL = "https://api.github.com/repos/$owner/$repo/issues/comments/$comment_id/reactions"
    }
