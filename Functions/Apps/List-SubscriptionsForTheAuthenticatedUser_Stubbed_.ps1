...
#>
Function List-SubscriptionsForTheAuthenticatedUser_Stubbed_
{
    [CmdletBinding()]
    Param(
    ...
    {
        $FinalURL = "https://api.github.com/user/marketplace_purchases/stubbed?$($QueryStrings -join '&')"
    }
    else
    {
        $FinalURL = "https://api.github.com/user/marketplace_purchases/stubbed"
    }
