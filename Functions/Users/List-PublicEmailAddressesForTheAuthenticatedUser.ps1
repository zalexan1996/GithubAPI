...
#>
Function List-PublicEmailAddressesForTheAuthenticatedUser
{
    [CmdletBinding()]
    Param(
    ...
    {
        $FinalURL = "https://api.github.com/user/public_emails?$($QueryStrings -join '&')"
    }
    else
    {
        $FinalURL = "https://api.github.com/user/public_emails"
    }
