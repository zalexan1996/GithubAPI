...
#>
Function List-PackagesForAnOrganization
{
    [CmdletBinding()]
    Param(
    ...
    {
        $FinalURL = "https://api.github.com/orgs/$org/packages?$($QueryStrings -join '&')"
    }
    else
    {
        $FinalURL = "https://api.github.com/orgs/$org/packages"
    }
