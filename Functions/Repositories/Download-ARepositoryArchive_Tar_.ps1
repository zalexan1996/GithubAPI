...
#>
Function Download-ARepositoryArchive_Tar_
{
    [CmdletBinding()]
    Param(
    ...
    {
        $FinalURL = "https://api.github.com/repos/$owner/$repo/tarball/$ref?$($QueryStrings -join '&')"
    }
    else
    {
        $FinalURL = "https://api.github.com/repos/$owner/$repo/tarball/$ref"
    }
