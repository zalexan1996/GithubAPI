...
Required. Value for your secret, encrypted with LibSodium using the public key retrieved from the Get an environment public key endpoint.
...
#>
Function Create-OrUpdateAnEnvironmentSecret
{
    [CmdletBinding()]
    Param(
