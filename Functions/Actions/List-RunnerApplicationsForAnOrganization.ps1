...
#>
Function List-RunnerApplicationsForAnOrganization
{
    [CmdletBinding()]
    Param(
    ...
    {
        $FinalURL = "https://api.github.com/orgs/$org/actions/runners/downloads?$($Querys -join '&')"
    }
    else
    {
        $FinalURL = "https://api.github.com/orgs/$org/actions/runners/downloads"
    }
